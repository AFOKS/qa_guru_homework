...
try:
    ...
    permanent_address_field.send_keys('''<script>alert('xss')</script>",
    "1' OR '1'='1",
    ":):):):))))::;)",
    "<div>HTML injection</div>''')
    ...
    assert "test@zxc.com" in result_box.text
